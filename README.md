# codepath_week1_assignment
# Project 1 - *w1a_flicks*

**w1a_flicks** shows the latest movies currently playing in theaters. The app utilizes the Movie Database API to display images and basic information about these movies to the user.
...
<img src='https://github.com/sharontaiwan/codepath_week1_assignment/blob/master/W1A_Flicks.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
